...
contract ImmutableCreate2Factory {
  ...
  /**
   * Unsafe create2 for use for ERADICATE2 address miner.
   */
  function ERADICATE2(
    bytes32 salt,
    bytes calldata initializationCode
  ...
  /**
   * This function can be used to get your bytecode hash for mining a vanity address for the contract.z
   */
  function getCodeHash(bytes calldata initCode) pure external returns (bytes32) {
